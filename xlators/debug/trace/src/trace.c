		  ...
		  struct stat *buf)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_create_cbk (*this=%p, op_ret=%d, op_errno=%d, *fd=%p), *buf=%p {st_dev=%lld, st_ino=%lld, st_mode=%d, st_nlink=%d, st_uid=%d, st_gid=%d, st_rdev=%llx, st_size=%lld, st_blksize=%ld, st_blocks=%lld, st_atime=%s, st_mtime=%s, st_ctime=%s})",
		...
		fd_t *fd)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_open_cbk (*this=%p, op_ret=%d, op_errno=%d, *fd=%p)",
		   ...
		   struct stat *buf)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_getattr_cbk (*this=%p, op_ret=%d, op_errno=%d, *buf=%p {st_dev=%lld, st_ino=%lld, st_mode=%d, st_nlink=%d, st_uid=%d, st_gid=%d, st_rdev=%llx, st_size=%lld, st_blksize=%ld, st_blocks=%lld, st_atime=%s, st_mtime=%s, st_ctime=%s})",
		 ...
		 int32_t count)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_read_cbk (*this=%p, op_ret=%d, op_errno=%d)",
		  ...
		  int32_t op_errno)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_writev_cbk (*this=%p, op_ret=%d, op_errno=%d)",
	  this, op_ret, op_errno);
		   ...
		   int32_t count)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_readdir_cbk (*this=%p, op_ret=%d, op_errno=%d, count=%d)",
		 ...
		 int32_t op_errno)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_fsync_cbk (*this=%p, op_ret=%d, op_errno=%d)",
	  this, op_ret, op_errno);
		 ...
		 struct stat *buf)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_chown_cbk (*this=%p, op_ret=%d, op_errno=%d, *buf=%p {st_dev=%lld, st_ino=%lld, st_mode=%d, st_nlink=%d, st_uid=%d, st_gid=%d, st_rdev=%llx, st_size=%lld, st_blksize=%ld, st_blocks=%lld, st_atime=%s, st_mtime=%s, st_ctime=%s})",
	  this, op_ret, op_errno, buf, buf->st_dev, buf->st_ino, buf->st_mode, buf->st_nlink, buf->st_uid, buf->st_gid, buf->st_rdev, buf->st_size, buf->st_blksize, buf->st_blocks, atime_buf, mtime_buf, ctime_buf);
		 ...
		 struct stat *buf)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_chmod_cbk (*this=%p, op_ret=%d, op_errno=%d, *buf=%p {st_dev=%lld, st_ino=%lld, st_mode=%d, st_nlink=%d, st_uid=%d, st_gid=%d, st_rdev=%llx, st_size=%lld, st_blksize=%ld, st_blocks=%lld, st_atime=%s, st_mtime=%s, st_ctime=%s})",
	  this, op_ret, op_errno, buf, buf->st_dev, buf->st_ino, buf->st_mode, buf->st_nlink, buf->st_uid, buf->st_gid, buf->st_rdev, buf->st_size, buf->st_blksize, buf->st_blocks, atime_buf, mtime_buf, ctime_buf);
		  ...
		  int32_t op_errno)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_unlink_cbk (*this=%p, op_ret=%d, op_errno=%d)",
	  this, op_ret, op_errno);
		  ...
		  struct stat *buf)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_rename_cbk (*this=%p, op_ret=%d, op_errno=%d, inode=%p, buf=%p)",
		    ...
		    char *buf)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_readlink_cbk (*this=%p, op_ret=%d, op_errno=%d, buf=%s)",
		   ...
		   struct stat *buf)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_symlink_cbk (*this=%p, op_ret=%d, op_errno=%d, *inode=%p, *buf=%p {st_dev=%lld, st_ino=%lld, st_mode=%d, st_nlink=%d, st_uid=%d, st_gid=%d, st_rdev=%llx, st_size=%lld, st_blksize=%ld, st_blocks=%lld, st_atime=%s, st_mtime=%s, st_ctime=%s})",
		 ...
		 struct stat *buf)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_mknod_cbk (*this=%p, op_ret=%d, op_errno=%d, *inode=%p, *buf=%p {st_dev=%lld, st_ino=%lld, st_mode=%d, st_nlink=%d, st_uid=%d, st_gid=%d, st_rdev=%llx, st_size=%lld, st_blksize=%ld, st_blocks=%lld, st_atime=%s, st_mtime=%s, st_ctime=%s})",
	  this, op_ret, op_errno, inode, buf, buf->st_dev, buf->st_ino, buf->st_mode, buf->st_nlink, buf->st_uid, buf->st_gid, buf->st_rdev, buf->st_size, buf->st_blksize, buf->st_blocks, atime_buf, mtime_buf, ctime_buf);
		 ...
		 struct stat *buf)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_mkdir_cbk (*this=%p, op_ret=%d, op_errno=%d",
	  this, op_ret, op_errno);
		...
		struct stat *buf)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_link_cbk (*this=%p, op_ret=%d, op_errno=%d, *buf=%p {st_dev=%lld, st_ino=%lld, st_mode=%d, st_nlink=%d, st_uid=%d, st_gid=%d, st_rdev=%llx, st_size=%lld, st_blksize=%ld, st_blocks=%lld, st_atime=%s, st_mtime=%s, st_ctime=%s})",
	  this, op_ret, op_errno, buf, buf->st_dev, buf->st_ino, buf->st_mode, buf->st_nlink, buf->st_uid, buf->st_gid, buf->st_rdev, buf->st_size, buf->st_blksize, buf->st_blocks, atime_buf, mtime_buf, ctime_buf);
		 ...
		 int32_t op_errno)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_flush_cbk (*this=%p, op_ret=%d, op_errno=%d)",
	  this, op_ret, op_errno);
		   ...
		   int32_t op_errno)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_release_cbk (*this=%p, op_ret=%d, op_errno=%d)",
	  this, op_ret, op_errno);
		   ...
		   fd_t *fd)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_opendir_cbk (*this=%p, op_ret=%d, op_errno=%d)",
	  this, op_ret, op_errno);
		 ...
		 int32_t op_errno)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_rmdir_cbk (*this=%p, op_ret=%d, op_errno=%d)",
	  this, op_ret, op_errno);
		    ...
		    struct stat *buf)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_truncate_cbk (*this=%p, op_ret=%d, op_errno=%d, *buf=%p {st_dev=%lld, st_ino=%lld, st_mode=%d, st_nlink=%d, st_uid=%d, st_gid=%d, st_rdev=%llx, st_size=%lld, st_blksize=%ld, st_blocks=%lld, st_atime=%s, st_mtime=%s, st_ctime=%s})",
	  this, op_ret, op_errno, buf, buf->st_dev, buf->st_ino, buf->st_mode, buf->st_nlink, buf->st_uid, buf->st_gid, buf->st_rdev, buf->st_size, buf->st_blksize, buf->st_blocks, atime_buf, mtime_buf, ctime_buf);
		 ...
		 struct stat *buf)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_utimes_cbk (*this=%p, op_ret=%d, op_errno=%d, *buf=%p {st_dev=%lld, st_ino=%lld, st_mode=%d, st_nlink=%d, st_uid=%d, st_gid=%d, st_rdev=%llx, st_size=%lld, st_blksize=%ld, st_blocks=%lld, st_atime=%s, st_mtime=%s, st_ctime=%s})",
	  this, op_ret, op_errno, buf, buf->st_dev, buf->st_ino, buf->st_mode, buf->st_nlink, buf->st_uid, buf->st_gid, buf->st_rdev, buf->st_size, buf->st_blksize, buf->st_blocks, atime_buf, mtime_buf, ctime_buf);
		  ...
		  struct statvfs *buf)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_statfs_cbk (*this=%p, *buf=%p {f_bsize=%u, f_frsize=%u, f_blocks=%lu, f_bfree=%lu, f_bavail=%lu, f_files=%lu, f_ffree=%lu, f_favail=%lu, f_fsid=%u, f_flag=%u, f_namemax=%u}) => ret=%d, errno=%d",
		    ...
		    int32_t op_errno)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_setxattr_cbk (*this=%p, op_ret=%d, op_errno=%d)",
	  this, op_ret, op_errno);
		    ...
		    void *value)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_getxattr_cbk (*this=%p, op_ret=%d, op_errno=%d)",
	  this, op_ret, op_errno);
		     ...
		     void *value)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_listxattr_cbk (*this=%p, op_ret=%d, op_errno=%d)",
	  this, op_ret, op_errno);
		       ...
		       int32_t op_errno)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_removexattr_cbk (*this=%p, op_ret=%d, op_errno=%d)",
	  this, op_ret, op_errno);
		      ...
		      int32_t op_errno)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_releasedir_cbk (*this=%p, op_ret=%d, op_errno=%d)",
	  this, op_ret, op_errno);
		    ...
		    int32_t op_errno)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_fsyncdir_cbk (*this=%p, op_ret=%d, op_errno=%d)",
	  this, op_ret, op_errno);
		  ...
		  int32_t op_errno)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_access_cbk (*this=%p, op_ret=%d, op_errno=%d)",
	  this, op_ret, op_errno);
		     ...
		     struct stat *buf)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_ftruncate_cbk (*this=%p, op_ret=%d, op_errno=%d, *buf=%p {st_dev=%lld, st_ino=%lld, st_mode=%d, st_nlink=%d, st_uid=%d, st_gid=%d, st_rdev=%llx, st_size=%lld, st_blksize=%ld, st_blocks=%lld, st_atime=%s, st_mtime=%s, st_ctime=%s})",
	  this, op_ret, op_errno, buf, buf->st_dev, buf->st_ino, buf->st_mode, buf->st_nlink, buf->st_uid, buf->st_gid, buf->st_rdev, buf->st_size, buf->st_blksize, buf->st_blocks, atime_buf, mtime_buf, ctime_buf);
		    ...
		    struct stat *buf)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_fgetattr_cbk (*this=%p, op_ret=%d, op_errno=%d, *buf=%p {st_dev=%lld, st_ino=%lld, st_mode=%d, st_nlink=%d, st_uid=%d, st_gid=%d, st_rdev=%llx, st_size=%lld, st_blksize=%ld, st_blocks=%lld, st_atime=%s, st_mtime=%s, st_ctime=%s})",
	  this, op_ret, op_errno, buf, buf->st_dev, buf->st_ino, buf->st_mode, buf->st_nlink, buf->st_uid, buf->st_gid, buf->st_rdev, buf->st_size, buf->st_blksize, buf->st_blocks, atime_buf, mtime_buf, ctime_buf);
	       ...
	       inode_t *inode)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_getattr (*this=%p, inode=%p)\n",
	  this, inode);
  STACK_WIND (frame, 
	      trace_getattr_cbk, 
	      FIRST_CHILD(this), 
		...
		size_t size)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_readlink (*this=%p, inode=%p, size=%d)",
	  this, inode, size);
	     ...
	     dev_t dev)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_mknod (*this=%p, parent=%p, name=%s, mode=%d, dev=%lld)",
	     ...
	     mode_t mode)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_mkdir (*this=%p, parent=%p, name=%s, mode=%d)",
	      ...
	      const char *name)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_unlink (*this=%p, parent=%p, name=%s)",
	  this, parent, name);
	     ...
	     const char *name)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_rmdir (*this=%p, parent=%p, name=%s)",
	  this, parent, name);
	       ...
	       const char *name)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_symlink (*this=%p, linkname=%s, inode=%p, name=%s)",
...
{  
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_rename (*this=%p, olddir=%p, oldname=%s, newdir=%p, newname=%s)",
	    ...
	    const char *newname)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_link (*this=%p, oldpath=%s, newpath=%s)",
	     ...
	     mode_t mode)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_chmod (*this=%p, inode=%p, mode=%o)",
	  this, inode, mode);
	     ...
	     gid_t gid)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_chown (*this=%p, inode=%p, uid=%d, gid=%d)",
	  this, inode, uid, gid);
		...
		off_t offset)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_truncate (*this=%p, inode=%p, offset=%lld)",
	  this, inode, offset);
	      ...
	      struct timespec *tv[2])
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_utimes (*this=%p, inode=%p, *tv=%p {actime=%s, modtime=%s})",
	    ...
	    mode_t mode)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_open (*this=%p, inode=%p, flags=%d, mode=%o)",
	      ...
	      mode_t mode)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_create (*this=%p, inode=%p, flags=0%o mode=0%o)",
	  this, inode, flags, mode);
	     ...
	     off_t offset)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_readv (*this=%p, *fd=%p, size=%d, offset=%ld)",
	  this, fd, size, offset);
	      ...
	      off_t offset)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_write (*this=%p, *fd=%p, *vector=%p, count=%d, offset=%ld)",
	      ...
	      inode_t *inode)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_statfs (*this=%p, inode=%p)",
	  this, inode);
	     ...
	     fd_t *fd)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_flush (*this=%p, *fd=%p)",
	  this, fd);
  STACK_WIND (frame, 
	      trace_flush_cbk, 
	      FIRST_CHILD(this), 
	       ...
	       fd_t *fd)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_release (*this=%p, *fd=%p)",
	  this, fd);
	     ...
	     int32_t flags)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_fsync (*this=%p, flags=%d, *fd=%p)",
	  this, flags, fd);
		...
		int32_t flags)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_setxattr (*this=%p, inode=%p, name=%s, value=%s, size=%ld, flags=%d)",
		...
		size_t size)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_getxattr (*this=%p, inode=%s, name=%s, size=%ld)",
		 ...
		 size_t size)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_listxattr (*this=%p, inode=%p, size=%ld)",
	  this, inode, size);
		   ...
		   const char *name)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_removexattr (*this=%p, inode=%p, name=%s)",
	  this, path, name);
	       ...
	       inode_t *inode)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_opendir (*this=%p, inode=%p)",
	  this, inode);
	       ...
	       inode_t *inode)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_readdir (*this=%p, inode=%p)",
	  this, inode);
...
{  
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_releasedir (*this=%p, *fd=%p)",
	  this, fd);
		...
		int32_t datasync)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_fsyncdir (*this=%p, datasync=%d, *fd=%p)",
	  this, datasync, fd);
	      ...
	      mode_t mode)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_access (*this=%p, *fd=%p, mode=%o)",
	  this, fd, mode);
		 ...
		 off_t offset)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_ftruncate (*this=%p, offset=%ld, *fd=%p)",
	  this, offset, fd);
		...
		fd_t *fd)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_fgetattr (*this=%p, *fd=%p)",
	  this, fd);
  STACK_WIND (frame, 
	      trace_fgetattr_cbk, 
	      FIRST_CHILD(this), 
	  ...
	  struct flock *lock)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "trace_lk (*this=%p, *fd=%p, cmd=%d, lock=%p {l_type=%d, l_whence=%d, l_start=%lld, l_len=%lld, l_pid=%ld})",
	  this, fd, cmd, lock,
	  lock->l_type, lock->l_whence, lock->l_start, lock->l_len, lock->l_pid);
...
init (xlator_t *this)
{
  ...
  if (this->children->next)
    {
      gf_log (this->name, GF_LOG_ERROR, "trace translator does not support more than one sub-volume");
      exit (-1);
    }
  ...
  if (debug && (strcasecmp (debug->data, "off") == 0))
    {
      ...
      gf_log (this->name, GF_LOG_DEBUG, "trace translator debug option is disabled loaded");
    }
...
fini (xlator_t *this)
{
  ...
  gf_log (this->name, GF_LOG_DEBUG, "fini (xlator_t *this=%p)", this);

  /* Free up the dictionary options */
  dict_destroy (FIRST_CHILD(this)->options);

  gf_log (this->name, GF_LOG_DEBUG, "trace translator unloaded");
  return;
}
